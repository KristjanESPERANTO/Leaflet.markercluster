...
import { animationMethods } from './MarkerClusterGroup.Animation.js'
...
export const MarkerClusterGroup = FeatureGroup.extend({
  ...
  addLayers: function (layersArray, skipLayerAddEvent) {
    ...
    if (this._map) {
      ...
      let needsClustering = new Array(l - offset) // improve performance by preallocating the maximum size of our array
      let tail = 0
  ...
  hasLayer: function (layer) {
    ...
    let i, anArray = this._needsClustering
  ...
  fire: function (type, data, propagate) {
    ...
    if (srcLayer instanceof MarkerCluster) {
  ...
  _showCoverage: function (e) {
    ...
    if (e.sourceTarget.getChildCount() > 2 && e.sourceTarget !== this._spiderfied) {
      this._shownPolygon = new Polygon(e.sourceTarget.getConvexHull(), this.options.polygonOptions)
...
// Provide class references to Refresh module to avoid circular dependency
setClusterClasses(MarkerClusterGroup, MarkerCluster)
